...
val domainModule = DI.Module("domainModule") {
    ...
    bind<BookInfoInteractor>() with provider {
        BookInfoInteractor(instance(), instance(), instance(), instance(), instance(), instance())
    }
    ...
    bind<ApplicationInteractor>() with provider {
        ApplicationInteractor(instance(), instance(), instance())
    }

    bind<UserInteractor>() with provider {
        UserInteractor(instance(), instance(), instance(), instance(), instance())
    }
