...
include(":common:cache-manager:api")
include(":common:cache-manager:data")
...
include(":feature:service-development:api")
include(":feature:service-development:data")
...
include(":feature:rating-review:compose")
include(":feature:rating-review:api")
include(":feature:rating-review:data")
include(":feature:rating-review:domain")
include(":feature:rating-review:presentation")
include(":feature:synchronization:api")
include(":feature:synchronization:data")
include(":feature:books-list-info:api")
include(":feature:books-list-info:presentation")
include(":feature:books-list-info:data")
include(":feature:books-list-info:domain")
include(":feature:books-list-info:compose")